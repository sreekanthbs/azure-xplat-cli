...
__.extend(Subnet.prototype, {
  create: function (resourceGroupName, vnetName, name, options, _) {
    ...
    try {
      self.networkManagementClient.subnets.createOrUpdate(resourceGroupName, vnetName, name, subnetProfile, _);
    } finally {
      progress.end();
    }
  ...
  set: function (resourceGroupName, vnetName, name, options, _) {
    ...
    try {
      self.networkManagementClient.subnets.createOrUpdate(resourceGroupName, vnetName, name, subnet, _);
    } finally {
      progress.end();
    }
    self.show(resourceGroupName, vnetName, name, options, _);
  ...
  get: function (resourceGroupName, vnetName, subnetName, _) {
    ...
    try {
      var subnet = self.networkManagementClient.subnets.get(resourceGroupName, vnetName, subnetName, _);
  ...
  delete: function (resourceGroupName, vnetName, name, options, _) {
    ...
    try {
      self.networkManagementClient.subnets.deleteMethod(resourceGroupName, vnetName, name, _);
    } finally {
      progress.end();
    }
  },
  ...
  _parseSubnet: function (resourceGroupName, vnetName, options, useDefaultSubnetCidr, _) {
    ...
    var vnet = self.networkManagementClient.virtualNetworks.get(resourceGroupName, vnetName, _);
    if (!vnet) {
