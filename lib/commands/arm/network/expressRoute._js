...
__.extend(ExpressRoute.prototype, {
  ...
  create: function (resourceGroupName, circuitName, location, options, _) {
    ...
    try {
      self.networkManagementClient.expressRouteCircuits.createOrUpdate(resourceGroupName, circuitName, parameters, _);
    } finally {
      progress.end();
    }
  ...
  set: function (resourceGroupName, circuitName, options, _) {
    ...
    try {
      self.networkManagementClient.expressRouteCircuits.createOrUpdate(resourceGroupName, circuitName, circuit, _);
    } finally {
      progress.end();
    }
    self.show(resourceGroupName, circuitName, options, _);
  ...
  list: function (resourceGroupName, options, _) {
    ...
    var circuits = null;
    try {
      circuits = self.networkManagementClient.expressRouteCircuits.list(resourceGroupName, _);
    } finally {
      progress.end();
    }
  ...
  get: function (resourceGroupName, circuitName, _) {
    ...
    try {
      var circuit = self.networkManagementClient.expressRouteCircuits.get(resourceGroupName, circuitName, _);
