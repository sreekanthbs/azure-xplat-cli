...
__.extend(LocalNetworkGateway.prototype, {
  ...
  list: function (resourceGroupName, options, _) {
    ...
    try {
      networks = self.networkManagementClient.localNetworkGateways.list(resourceGroupName, _);
    } finally {
      progress.end();
    }
  ...
  delete: function (resourceGroupName, name, options, _) {
    ...
    try {
      self.networkManagementClient.localNetworkGateways.deleteMethod(resourceGroupName, name, _);
    } finally {
      progress.end();
    }
  },
  ...
  get: function (resourceGroupName, name, _) {
    ...
    try {
      var gateway = self.networkManagementClient.localNetworkGateways.get(resourceGroupName, name, _);
  ...
  _createOrUpdate: function (resourceGroupName, name, parameters, isCreating, _) {
    ...
    try {
      self.networkManagementClient.localNetworkGateways.createOrUpdate(resourceGroupName, name, parameters, _);
    } finally {
      progress.end();
    }
  },
