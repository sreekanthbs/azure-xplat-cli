...
__.extend(Nic.prototype, {
  ...
  update: function (resourceGroupName, nicName, nic, _) {
    ...
    var progress = self.interaction.progress(util.format($('Updating network interface "%s"'), nicName));
    try {
      var nic = self.networkManagementClient.networkInterfaces.createOrUpdate(resourceGroupName, nicName, nic, _);
      return nic;
    } finally {
      progress.end();
    }
  ...
  addBackendAddressPool: function (resourceGroupName, nicName, options, _) {
    this._updateBackendAddressPool(resourceGroupName, nicName, options, true, _);
  },

  removeBackendAddressPool: function (resourceGroupName, nicName, options, _) {
    this._updateBackendAddressPool(resourceGroupName, nicName, options, false, _);
  },

  addInboundNatRule: function (resourceGroupName, nicName, options, _) {
    this._updateInboundNatRule(resourceGroupName, nicName, options, true, _);
  },

  removeInboundNatRule: function (resourceGroupName, nicName, options, _) {
