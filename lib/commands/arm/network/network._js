...
exports.init = function (cli) {
  ...
  vnet.command('create [resource-group] [name] [location]')
    ...
    .option('-t, --tags <tags>', $(constants.tags.createHelp))
  ...
  vnet.command('set [resource-group] [name]')
    ...
    .option('-t, --tags [tags]', $(constants.tags.setHelp))
    .option('-s, --subscription <subscription>', $('the subscription identifier'))
  ...
  lbFrontendIP.command('create [resource-group] [lb-name] [name]')
    ...
    .option('-u, --public-ip-id <public-ip-id>', $('the public ip address identifier.' +
    ...
    .option('-b, --subnet-id <subnet-id>', $('the subnet identifier.' +
  ...
  lbRule.command('create [resource-group] [lb-name] [name]')
    ...
    .execute(function (resourceGroup, lbName, name, options, _) {
      ...
      var networkManagementClient = getNetworkResourceProviderClient(options); // TODO deprecated, use getNetworkManagementClient
      var loadBalancer = new LoadBalancer(cli, networkManagementClient);
  ...
  // TODO deprecated, use getNetworkManagementClient instead
