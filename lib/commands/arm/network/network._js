...
exports.init = function (cli) {
  ...
  var authorization =  expressRoute.category('authorization')
    .description($('Commands to manage express routes authorization'));

  authorization.command('create [resource-group] [circuit-name] [name]')
    ...
    .option('-u, --status <status>', $('the express route circuit authorization status'))
    .option('-s, --subscription <subscription>', $('the subscription identifier'))
    .execute(function (resourceGroup, circuitName, name, options, _) {
      ...
      expressRoute.createAuth(resourceGroup, circuitName, name, options, _);
    });

  authorization.command('set [resource-group] [circuit-name] [name]')
    .description($('Set express route circuit'))
    .usage('[options] <resource-group> <circuit-name> <name>')
    .option('-g, --resource-group <resource-group>', $('the name of the resource group'))
    .option('-c, --circuit-name <circuit-name>', $('the name of the express route circuit'))
    .option('-n, --name <name>', $('the name of the express route circuit authorization'))
    .option('-k, --key <key>', $('the express route circuit authorization key'))
    .option('-u, --status <status>', util.format($('the express route circuit authorization status, ' +
      '\n    valid values are [%s}. default value is "%s"'), constants.expressRouteAuth.status, constants.expressRouteAuth.status[0]))
    .option('-s, --subscription <subscription>', $('the subscription identifier'))
    .execute(function (resourceGroup, circuitName, name, options, _) {
      resourceGroup = cli.interaction.promptIfNotGiven($('Resource group name: '), resourceGroup, _);
      circuitName = cli.interaction.promptIfNotGiven($('Express route circuit name: '), circuitName, _);
      ...
      var networkResourceProviderClient = getNetworkResourceProviderClient(options);
      var expressRoute = new ExpressRoute(cli, networkResourceProviderClient);
      expressRoute.setAuth(resourceGroup, circuitName, name, options, _);
    });

  authorization.command('show [resource-group] [circuit-name] [name]')
    .description($('Show express route circuit'))
    .usage('[options] <resource-group> <circuit-name> <name>')
    .option('-g, --resource-group <resource-group>', $('the name of the resource group'))
    .option('-c, --circuit-name <circuit-name>', $('the name of the express route circuit'))
    .option('-n, --name <name>', $('the name of the express route circuit authorization'))
    ...
    .execute(function (resourceGroup, circuitName, name, options, _) {
      ...
      var networkResourceProviderClient = getNetworkResourceProviderClient(options);
      var expressRoute = new ExpressRoute(cli, networkResourceProviderClient);
      expressRoute.showAuth(resourceGroup, circuitName, name, options, _);
    });

  authorization.command('delete [resource-group] [circuit-name] [name]')
    .description($('Delete express route circuit'))
    .usage('[options] <resource-group> <circuit-name> <name>')
    .option('-g, --resource-group <resource-group>', $('the name of the resource group'))
    .option('-c, --circuit-name <circuit-name>', $('the name of the express route circuit'))
    .option('-n, --name <name>', $('the name of the express route circuit authorization'))
    ...
    .execute(function (resourceGroup, circuitName, name, options, _) {
      ...
      var networkResourceProviderClient = getNetworkResourceProviderClient(options);
      var expressRoute = new ExpressRoute(cli, networkResourceProviderClient);
      expressRoute.deleteAuth(resourceGroup, circuitName, name, options, _);
    });

  authorization.command('list [resource-group] [circuit-name]')
    ...
    .execute(function (resourceGroup, circuitName, options, _) {
      ...
      var networkResourceProviderClient = getNetworkResourceProviderClient(options);
      var expressRoute = new ExpressRoute(cli, networkResourceProviderClient);
      expressRoute.listAuth(resourceGroup, circuitName, options, _);
    });
