...
exports.init = function (cli) {
  ...
  var vpnConnection = network.category('vpn-connection')
    .description($('Commands to manage gateway connections'));

  vpnConnection.command('create [resource-group] [name] [location]')
  ...
  vpnConnection.command('set [resource-group] [name]')
    .description($('Sets a gateway connection'))
    .usage('[options] <resource-group> <name>')
    .option('-g, --resource-group <resource-group>', $('the name of the resource group'))
    .option('-n, --name <name>', $('the name of the gateway connection'))
    .option('-w, --routing-weight <routing-weight>', $('the routing weight'))
  ...
  vpnConnection.command('list [resource-group]')
  ...
  vpnConnection.command('show [resource-group] [name]')
  ...
  vpnConnection.command('delete [resource-group] [name]')
    .usage('[options] <resource-group> <name>')
