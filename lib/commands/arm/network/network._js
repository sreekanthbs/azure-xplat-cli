...
exports.init = function (cli) {
  ...
  nicAddressPool.command('add [resource-group] [name]')
    ...
    .option('-g, --resource-group <resource-group>', $('the name of the resource group'))
    .option('-n, --name <name>', $('the name of the network interface'))
    .option('-i, --lb-address-pool-id <lb-address-pool-id>', util.format($('the load balancer address pool identifier' +
    '\n   e.g. %s'), constants.help.id.lbAddressPool))
  ...
  nicInboundRule.command('add [resource-group] [name]')
    ...
    .option('-g, --resource-group <resource-group>', $('the name of the resource group'))
    .option('-n, --name <name>', $('the name of the network interface'))
    .option('-i, --inbound-nat-rule-id <inbound-nat-rule-id>', util.format($('the inbound NAT rule identifier.' +
    '\n   e.g. %s'), constants.help.id.lbInboundNatRule))
    .option('-l, --lb-name <lb-name>', $('the load balancer name.' +
    '\n   This load balancer must exists in the same resource group as the NIC.' +
