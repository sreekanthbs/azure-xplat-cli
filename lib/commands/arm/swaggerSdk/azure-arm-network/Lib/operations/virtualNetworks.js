 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
VirtualNetworks.prototype.get = function (resourceGroupName, virtualNetworkName, expand, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
  ...
  return client.pipeline(httpRequest, function (err, response, responseBody) {
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        if (parsedResponse) {
          result = new client._models['VirtualNetwork'](parsedResponse);
        }
...
VirtualNetworks.prototype.beginCreateOrUpdate = function (resourceGroupName, virtualNetworkName, parameters, options, callback) {
  ...
  try {
    if (parameters) {
      requestModel = new client._models['VirtualNetwork'](parameters);
    }
  ...
  return client.pipeline(httpRequest, function (err, response, responseBody) {
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        result = JSON.parse(responseBody);
        if (parsedResponse) {
          result = new client._models['VirtualNetworkListResult'](parsedResponse);
        }
        if (parsedResponse !== null && parsedResponse !== undefined) {
          result.deserialize(parsedResponse);
        }
