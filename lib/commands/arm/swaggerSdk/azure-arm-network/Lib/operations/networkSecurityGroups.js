 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
NetworkSecurityGroups.prototype.get = function (resourceGroupName, networkSecurityGroupName, expand, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
  ...
  return client.pipeline(httpRequest, function (err, response, responseBody) {
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        if (parsedResponse) {
          result = new client._models['NetworkSecurityGroup'](parsedResponse);
        }
...
NetworkSecurityGroups.prototype.beginCreateOrUpdate = function (resourceGroupName, networkSecurityGroupName, parameters, options, callback) {
  ...
  try {
    if (parameters) {
      requestModel = new client._models['NetworkSecurityGroup'](parameters);
    }
  ...
  return client.pipeline(httpRequest, function (err, response, responseBody) {
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        result = JSON.parse(responseBody);
        if (parsedResponse) {
          result = new client._models['NetworkSecurityGroupListResult'](parsedResponse);
        }
        if (parsedResponse !== null && parsedResponse !== undefined) {
          result.deserialize(parsedResponse);
        }
