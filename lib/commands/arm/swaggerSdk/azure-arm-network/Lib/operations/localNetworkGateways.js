  ...
  this.beginCreateOrUpdate(resourceGroupName, localNetworkGatewayName, parameters, options, function (err, parsedResult, httpRequest, response){
    ...
    client.getPutOrPatchOperationResult(initialResult, options, function (err, pollingResult) {
      ...
      try {
        ...
        if (parsedResponse) {
          result = new client._models['LocalNetworkGateway'](parsedResponse);
        }
...
LocalNetworkGateways.prototype.beginCreateOrUpdate = function (resourceGroupName, localNetworkGatewayName, parameters, options, callback) {
  ...
  try {
    if (parameters) {
      requestModel = new client._models['LocalNetworkGateway'](parameters);
    }
  ...
  return client.pipeline(httpRequest, function (err, response, responseBody) {
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        result = JSON.parse(responseBody);
        if (parsedResponse) {
          result = new client._models['LocalNetworkGatewayListResult'](parsedResponse);
        }
        if (parsedResponse !== null && parsedResponse !== undefined) {
          result.deserialize(parsedResponse);
        }
