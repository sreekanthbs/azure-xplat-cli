...
Routes.prototype.deleteMethod = function (resourceGroupName, routeTableName, routeName, options, callback) {
  ...
  // Send request
  this.beginDeleteMethod(resourceGroupName, routeTableName, routeName, options, function (err, parsedResult, httpRequest, response){
  ...
  return client.pipeline(httpRequest, function (err, response, responseBody) {
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        if (parsedResponse) {
          result = new client._models['Route'](parsedResponse);
        }
 ...
 * Azure hop the packet should be sent to. Possible values for this property
...
Routes.prototype.createOrUpdate = function (resourceGroupName, routeTableName, routeName, routeParameters, options, callback) {
  ...
  // Send request
  this.beginCreateOrUpdate(resourceGroupName, routeTableName, routeName, routeParameters, options, function (err, parsedResult, httpRequest, response){
    if (err) return callback(err);
...
Routes.prototype.beginCreateOrUpdate = function (resourceGroupName, routeTableName, routeName, routeParameters, options, callback) {
  ...
  try {
    if (routeParameters) {
      requestModel = new client._models['Route'](routeParameters);
    }
  ...
  return client.pipeline(httpRequest, function (err, response, responseBody) {
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        result = JSON.parse(responseBody);
        if (parsedResponse) {
          result = new client._models['RouteListResult'](parsedResponse);
        }
        if (parsedResponse !== null && parsedResponse !== undefined) {
          result.deserialize(parsedResponse);
        }
