 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
NetworkInterfaces.prototype.get = function (resourceGroupName, networkInterfaceName, expand, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
  ...
  return client.pipeline(httpRequest, function (err, response, responseBody) {
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        if (parsedResponse) {
          result = new client._models['NetworkInterface'](parsedResponse);
        }
...
NetworkInterfaces.prototype.beginCreateOrUpdate = function (resourceGroupName, networkInterfaceName, parameters, options, callback) {
  ...
  try {
    if (parameters) {
      requestModel = new client._models['NetworkInterface'](parameters);
    }
  ...
  return client.pipeline(httpRequest, function (err, response, responseBody) {
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        result = JSON.parse(responseBody);
        if (parsedResponse) {
          result = new client._models['NetworkInterfaceListResult'](parsedResponse);
        }
        if (parsedResponse !== null && parsedResponse !== undefined) {
          result.deserialize(parsedResponse);
        }
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
NetworkInterfaces.prototype.getVirtualMachineScaleSetNetworkInterface = function (resourceGroupName, virtualMachineScaleSetName, virtualmachineIndex, networkInterfaceName, expand, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
