  ...
  return client.pipeline(httpRequest, function (err, response, responseBody) {
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        if (parsedResponse) {
          result = new client._models['ExpressRouteCircuit'](parsedResponse);
        }
 ...
 * Possible values for this property include: 'UnlimitedData', 'MeteredData'.
 * 
...
ExpressRouteCircuits.prototype.beginCreateOrUpdate = function (resourceGroupName, circuitName, parameters, options, callback) {
  ...
  try {
    if (parameters) {
      requestModel = new client._models['ExpressRouteCircuit'](parameters);
    }
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
ExpressRouteCircuits.prototype.listArpTable = function (resourceGroupName, circuitName, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
  ...
  return client.pipeline(httpRequest, function (err, response, responseBody) {
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        result = JSON.parse(responseBody);
        if (parsedResponse) {
          result = new client._models['ExpressRouteCircuitsArpTableListResult'](parsedResponse);
        }
        if (parsedResponse !== null && parsedResponse !== undefined) {
          result.deserialize(parsedResponse);
        }
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
ExpressRouteCircuits.prototype.listRoutesTable = function (resourceGroupName, circuitName, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
  ...
  return client.pipeline(httpRequest, function (err, response, responseBody) {
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        result = JSON.parse(responseBody);
        if (parsedResponse) {
          result = new client._models['ExpressRouteCircuitsRoutesTableListResult'](parsedResponse);
        }
        if (parsedResponse !== null && parsedResponse !== undefined) {
          result.deserialize(parsedResponse);
        }
 ...
 *
 *                      {object} [result]   - The deserialized result object.
 *                      See {@link ExpressRouteCircuitsStatsListResult} for
 *                      more information.
 *
 *                      {object} [request]  - The HTTP Request object if an error did not occur.
 *
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
ExpressRouteCircuits.prototype.listStats = function (resourceGroupName, circuitName, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
  ...
  return client.pipeline(httpRequest, function (err, response, responseBody) {
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        result = JSON.parse(responseBody);
        if (parsedResponse) {
          result = new client._models['ExpressRouteCircuitsStatsListResult'](parsedResponse);
        }
        if (parsedResponse !== null && parsedResponse !== undefined) {
          result.deserialize(parsedResponse);
        }
  ...
  return client.pipeline(httpRequest, function (err, response, responseBody) {
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        result = JSON.parse(responseBody);
        if (parsedResponse) {
          result = new client._models['ExpressRouteCircuitListResult'](parsedResponse);
        }
        if (parsedResponse !== null && parsedResponse !== undefined) {
          result.deserialize(parsedResponse);
        }
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
ExpressRouteCircuits.prototype.listArpTableNext = function (nextPageLink, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
ExpressRouteCircuits.prototype.listRoutesTableNext = function (nextPageLink, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
ExpressRouteCircuits.prototype.listStatsNext = function (nextPageLink, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
