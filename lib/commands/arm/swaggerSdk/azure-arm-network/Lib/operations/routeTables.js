 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
RouteTables.prototype.get = function (resourceGroupName, routeTableName, expand, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
  ...
  return client.pipeline(httpRequest, function (err, response, responseBody) {
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        if (parsedResponse) {
          result = new client._models['RouteTable'](parsedResponse);
        }
...
RouteTables.prototype.beginCreateOrUpdate = function (resourceGroupName, routeTableName, parameters, options, callback) {
  ...
  try {
    if (parameters) {
      requestModel = new client._models['RouteTable'](parameters);
    }
  ...
  return client.pipeline(httpRequest, function (err, response, responseBody) {
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        result = JSON.parse(responseBody);
        if (parsedResponse) {
          result = new client._models['RouteTableListResult'](parsedResponse);
        }
        if (parsedResponse !== null && parsedResponse !== undefined) {
          result.deserialize(parsedResponse);
        }
