...
exports.createAutoRestClient = function (FactoryMethod, credentials, subscriptionId, endpoint) {
  var options = {};
  options.filters = [
    exports.certAuthFilter(credentials), 
    log.createLogFilter(), azureCommon.UserAgentFilter.create(exports.getUserAgent()),
    exports.createPostBodyFilter(),
    exports.createFollowRedirectFilter(),
    polishErrorCausedByArmProviderNotRegistered()
    ];
  
  var client = new FactoryMethod(credentials, subscriptionId, exports.stringTrimEnd(endpoint, '/'), options);
  return client;
};
...
function _createAutoRestArmClient(factoryMethod, subscription) {
  return exports.createAutoRestClient(factoryMethod,
    subscription._createCredentials(),
    subscription.id,
...
exports.createRedisCacheManagementClient = function (subscription) {
  ...
  return _createAutoRestArmClient(factoryMethod, subscription);
};
...
// TODO remove, use createNetworkManagementClient instead
...
exports.createNetworkManagementClient = function (subscription) {
  // TODO replace with require('azure-arm-network');
  var factoryMethod = require('./../commands/arm/swaggerSdk/azure-arm-network');
  return _createAutoRestArmClient(factoryMethod, subscription);
};
...
exports.createDataLakeStoreFileSystemManagementClient = function (subscription, options) {
  ...
  if(!options) {
    options = {
      endpoint: subscription.azureDataLakeStoreFileSystemEndpointSuffix,
  ...
  if(!options.endpoint) {
    options.endpoint = subscription.azureDataLakeStoreFileSystemEndpointSuffix;
  }
  ...
  var factoryMethod = require('azure-arm-datalake-store').createDataLakeStoreFileSystemManagementClient;
...
exports.createDataLakeStoreManagementClient = function (subscription) {
  var factoryMethod = require('azure-arm-datalake-store').createDataLakeStoreManagementClient;
  return _createArmClient(factoryMethod, subscription);
};
